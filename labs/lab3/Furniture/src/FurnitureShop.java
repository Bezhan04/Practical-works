...
public class FurnitureShop {
    ...
    public FurnitureShop(String name, String location) { this.name = name;
    ...
    public ArrayList<Furniture> getFurnitures() { return furnitures;
    }

    public void setFurnitures(ArrayList<Furniture> furnitures) { this.furnitures = furnitures;
    }
