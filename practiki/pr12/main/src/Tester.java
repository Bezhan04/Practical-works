    ...
    public static void main(String[] args) {
        {
            ...
            Person person2 = new Person("Bezhan"); System.out.println(person1.getShort()); System.out.println(person2.getShort());
        }
        System.out.println();
        {
            ...
            System.out.println(); new
                Address("Japan.TokyoDistrict.Tokyo.AnimeTop.2007.noBuildingJustHokage.10007").print();
        }
        System.out.println();
        {
            Shirt shirtStore = new Shirt("root"); shirtStore.fillArray();
            for (Shirt a : shirtStore.toShirtArray()) System.out.println(a.toString());
        }
        System.out.println();
        {
            ...
            number.setLength(0); number.append("89175655655");
            System.out.println(new  PhoneNumber(number).getNumber());
        }
        System.out.println();
        {
            Scanner scanner = new Scanner(System.in); String fileName = scanner.nextLine(); String[] s = fileName.split(" ");

            StringBuilder result = getLine(s); System.out.println(result);
