...
public class App {
    ...
    private boolean retreiveCards() {
        ...
        for (int i = 0; i < textFields.size(); i++) {
            ...
            if (i < 5) player1Cards.add(Card.findCardByValue(Integer.parseInt(trim)));
            else
    ...
    private JMenuBar getMenuBar() {
        ...
        appMenu.add(new JMenuItem(new AbstractAction("About") {
            ...
            public void actionPerformed(ActionEvent e) {
                JOptionPane.showMessageDialog(frame, "App created Bezhan Kasymov :)");
            }
        }));
            ...
            public void actionPerformed(ActionEvent e) {
                if (retreiveCards()) {
                    ...
                    if (winner != null)
                        ...
                        JOptionPane.showMessageDialog(frame, "botva " +
                                game.getStep());
                }
            }
        }));
