public class WaitListTester {
    public static void main(String[] args) {
        ...
        if (boundedWaitList.contains(boundedWaitList.content.peek())) System.out.println("boundedWaitList contains " +
                boundedWaitList.content.peek().toString());
        boundedWaitList.remove();
        System.out.println(boundedWaitList);
        boundedWaitList.add(new Person("Person n_6"));
        System.out.println(boundedWaitList);
        UnfairWaitList<Person> unfairWaitList = new
                UnfairWaitList<Person>();
