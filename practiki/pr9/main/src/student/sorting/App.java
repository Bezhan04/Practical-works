...
import javax.swing.AbstractAction; import javax.swing.JFrame;
    ...
    public JMenuBar getJMenuBar() {
        ...
        appMenu.add(new JMenuItem(new AbstractAction("About") {
            ...
            public void actionPerformed(ActionEvent e) {
                JOptionPane.showMessageDialog(frame, "App created by Kasymov Bezhan :)");
            }
        }));
        ...
        sortingMenu.add(new JMenuItem(new AbstractAction("By ID") {
            @Override
            public void actionPerformed(ActionEvent e) {
                StudentManager.sort(group.getStudents(), 0,
                        group.getStudents().size() - 1, new SortStudentById());
        ...
        sortingMenu.add(new JMenuItem(new AbstractAction("By GPA") {
            ...
            public void actionPerformed(ActionEvent e) {
                StudentManager.sort(group.getStudents(), 0,
                        group.getStudents().size() - 1, new SortStudentByGpa());
                group.fireTableDataChanged();
            }
        }));
        ...
        searchMenu.add(new JMenuItem(new AbstractAction("By name") {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(frame, String.format("%d: %s (%s)",
                            student.getId(), student.getName(), student.getGpa()));
